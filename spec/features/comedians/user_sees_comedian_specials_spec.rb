...
describe "as a user on the comedian index" do
  describe "when I see a comedian box" do
    it "displays all comedian specials" do
      ...
      special_2a = comedian_1.specials.create(name: "Live in Boston!", runtime_mins: 70, image_url: "https://www.images.funny_people/2a")
      special_3a = comedian_1.specials.create(name: "Live in Chitown!", runtime_mins: 80, image_url: "https://www.images.funny_people/3a")

      special_1b = comedian_2.specials.create(name: "Live in Pelham, AL!", runtime_mins: 60, image_url: "https://www.images.funny_people/1b")
      special_2b = comedian_2.specials.create(name: "Live in Pelham, NH!", runtime_mins: 70, image_url: "https://www.images.funny_people/2b")
