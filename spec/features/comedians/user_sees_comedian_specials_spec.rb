...
describe "as a user on the comedian index" do
  describe "when I see a comedian box" do
    it "displays all comedian specials" do
      ...
      special_1a = comedian_1.specials.create(name: "Live in NY!", runtime_mins: 60)
      special_2a = comedian_1.specials.create(name: "Live in Boston!", runtime_mins: 70)
      special_3a = comedian_1.specials.create(name: "Live in Chitown!", runtime_mins: 80)

      special_1b = comedian_2.specials.create(name: "Live in Pelham, AL!", runtime_mins: 60)
      special_2b = comedian_2.specials.create(name: "Live in Pelham, NH!", runtime_mins: 70)
      special_3b = comedian_2.specials.create(name: "Live in Pelham, GA!", runtime_mins: 80)
